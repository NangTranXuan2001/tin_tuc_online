...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 16, 2022 lúc 03:37 AM
...
CREATE TABLE `phananh` (
  `id_phananh` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `tieude_phananh` text COLLATE utf8_unicode_ci NOT NULL,
  `noidung_phananh` text COLLATE utf8_unicode_ci NOT NULL,
  `ngay_phananh` date NOT NULL,
  `trangthai_phananh` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `bantin`
  MODIFY `id_bantin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `phananh`
  MODIFY `id_phananh` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `phananh`
--
ALTER TABLE `phananh`
  ADD CONSTRAINT `phananh_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
